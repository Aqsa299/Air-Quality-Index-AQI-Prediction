...
Original file is located at
    https://colab.research.google.com/drive/1KMZzl7zJ7jURNssiH1drZY_wVpONB3-o
"""
...
def get_data():
    ...
    project = hopsworks.login(
        project="MyAQI_Predictor",  # Replace with your Hopsworks project name
        api_key_value="your_api_key_here",  # Replace with your API key
    )
    fs = project.get_feature_store()
...
# Import the get_data function from streamlit_app.py
from streamlit_app import get_data

# Call the function and unpack the returned values
df, project = get_data()  # Unpack into df and project
